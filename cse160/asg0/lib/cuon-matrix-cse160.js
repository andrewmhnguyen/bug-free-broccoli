...
class Vector3 {
    ...
    static cross(other1, other2) {
        ...
        let v3 = new Vector3([0, 0, other1.elements[0]*other2.elements[1] - other1.elements[1]*other2.elements[0]]); // Modify this line to calculate cross product between other1 and other2.
