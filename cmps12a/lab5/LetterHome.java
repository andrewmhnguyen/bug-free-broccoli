...
//lab5
//
//error 1: remove the equal from the if statement
//error 2: remove that semicolon
//error 3: there is a semicolon after else - if not 3 leads to phrase being ERROR
