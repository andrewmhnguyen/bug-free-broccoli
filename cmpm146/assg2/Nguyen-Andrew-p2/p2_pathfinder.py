...
def find_path (source_point, destination_point, mesh):
    ...
    if start_box == destination:
        newPath.append((source_point, destination_point))
    ...
    if destination in mesh['adj'][start_box]:
        points = []
        points.append((source_point, helper_box(source_point, start_box, destination)))
        points.append((helper_box(source_point, start_box, destination), destination_point))
    ...
    while len(queue) != 0:
        ...
        for box in mesh['adj'][current_box]:
            ...
            if current_goal == 'destination':
                ...
                pathcost = backward_distances[current_box] + euclidean_helper(detail_points[current_box], source_point) + euclidean_helper(detail_points[current_box], point_check)
                # If the cost is new
    ...
    '''
    midpoint = helper_box(detail_points[pathForward[0]], pathForward[0], pathBackward[0])
    midpoint2 = helper_box(detail_points[pathBackward[0]], pathBackward[0], pathForward[0])

    newPath.append((detail_points[pathForward[0]], midpoint))
    newPath.append((midpoint,midpoint2))
    newPath.append((midpoint2, detail_points[pathBackward[0]]))
    '''
    newBoxes.append(start_box)
    newBoxes.append(destination)
